                    ...
                    <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Apple Tăng Cường Bảo Mật: Cập Nhật iOS Mới Nhất

                                </h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">15 Tháng 10, 2023
                        ...
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Sự Kiện Ra Mắt: Hãy Chờ Đón Những Mẫu iPhone Mới Nhất!</h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">22 Tháng 10, 2023</span>
                                <p className="text-dark">Phone Store mời bạn tham dự sự kiện ra mắt trực tuyến của chúng tôi, nơi chúng tôi sẽ giới thiệu các mẫu iPhone mới nhất từ Apple. Đăng ký ngay hôm nay để có cơ hội nhận được các ưu đãi đặc biệt và quà tặng khi bạn đặt hàng trước.</p>
                            </div>
                        </a>
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Đánh Giá và So Sánh: iPhone 14 Pro Max vs. iPhone 13 Pro Max</h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">29 Tháng 10, 2023</span>
                                <p className="text-dark">Bạn đang phân vân giữa việc nâng cấp lên iPhone 14 Pro Max hay giữ lại iPhone 13 Pro Max? Đừng lo, Phone Store đã so sánh chi tiết giữa hai mẫu điện thoại này để bạn có thể quyết định dễ dàng hơn. Tìm hiểu về sự khác biệt trong hiệu suất, camera, và nhiều hơn nữa.</p>
                            </div>
                        </a>
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900 hidden sm:block">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Giải Đáp Thắc Mắc: Những Câu Hỏi Thường Gặp Khi Sử Dụng iPhone</h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">5 Tháng 11, 2023</span>
                                <p className="text-dark">Phone Store tổ chức một buổi Q&A đặc biệt, giải đáp mọi thắc mắc của bạn về iPhone. Từ các mẹo sử dụng hàng ngày đến cách giải quyết các vấn đề kỹ thuật, chúng tôi đều có câu trả lời. Gửi câu hỏi của bạn và hãy chú ý đến mục Tin Tức của chúng tôi để nhận được câu trả lời!</p>
                            </div>
                        </a>
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900 hidden sm:block">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Cập Nhật Sản Phẩm: Phiên Bản Màu Sắc Mới Của iPhone 14 Đã Sẵn Sàng</h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">12 Tháng 11, 2023</span>
                                <p className="text-dark">Mùa này, Apple đem đến một làn sóng mới với phiên bản màu sắc mới của iPhone 14, bổ sung thêm sự tinh tế vào dòng sản phẩm đã rất thành công này. Phone Store giới thiệu độc quyền các mẫu màu mới này, từ màu xanh dương sâu thẳm đến màu hồng pastel nhẹ nhàng. Khám phá và chọn lựa màu sắc phản ánh phong cách của bạn.</p>
                            </div>
                        </a>
                        <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:dark:bg-gray-900 hidden sm:block">
                            ...
                            <div className="p-6 space-y-2">
                                <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">Tư Vấn Mua Sắm: Làm Thế Nào Để Chọn iPhone Phù Hợp Với Nhu Cầu Của Bạn</h3>
                                <span className="text-xs dark:dark:text-gray-400 text-dark">19 Tháng 11, 2023</span>
                                <p className="text-dark">Với vô số lựa chọn từ dòng sản phẩm iPhone, việc tìm ra chiếc điện thoại hoàn hảo cho bạn có thể trở nên khó khăn. Đừng lo, đội ngũ chuyên gia của Phone Store đã soạn ra một hướng dẫn chi tiết để giúp bạn quyết định. Từ hiệu năng đến ngân sách, hãy tìm hiểu những yếu tố nên cân nhắc khi chọn mua iPhone.</p>
                            </div>
                        </a>
                    </div>
