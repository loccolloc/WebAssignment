        ...
        <div className='bg-white/10 backdrop-blur-md shadow-lg rounded-lg border border-gray-200'>
            ...
            <section className="p-6 dark:dark:bg-gray-800 dark:dark:text-gray-100">
                <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
                    ...
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leadi lg:text-6xl">80k</p>
                    ...
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        ...
                        <p className="text-sm sm:text-base">Dòng iPhone</p>
                    </div>
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                    ...
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leadi lg:text-6xl">10</p>
                        <p className="text-sm sm:text-base">Năm bán hàng

                        </p>
                    </div>
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leadi lg:text-6xl">100+</p>
                        <p className="text-sm sm:text-base">Sản phẩm
                ...
                <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:dark:bg-violet-400 dark:dark:text-gray-900">
                            <img src="https://source.unsplash.com/50x50/?portrait?1" alt className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full  dark:dark:bg-gray-700" />
                            <p className="text-xl font-semibold leadi">Hải Đăng</p>
                    ...
                    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:dark:bg-violet-400 dark:dark:text-gray-900">
                            <img src="https://source.unsplash.com/50x50/?portrait?2" alt className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full  dark:dark:bg-gray-700" />
                            <p className="text-xl font-semibold leadi">Xuân Lộc</p>
                            <p className="text-sm uppercase">Aliquam illum</p>
                        </div>
                    </div>
                    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:dark:bg-violet-400 dark:dark:text-gray-900">
                            <img src="https://source.unsplash.com/50x50/?portrait?3" alt className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full  dark:dark:bg-gray-700" />
                            <p className="text-xl font-semibold leadi">Anh Vũ</p>
                            <p className="text-sm uppercase">Aliquam illum</p>
                        </div>
                    </div>
                    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:dark:bg-violet-400 dark:dark:text-gray-900">
                            <img src="https://source.unsplash.com/50x50/?portrait?4" alt className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full  dark:dark:bg-gray-700" />
                            <p className="text-xl font-semibold leadi">Quốc Vũ</p>
                            <p className="text-sm uppercase">Aliquam illum</p>
                        </div>
                    </div>
                </div>
