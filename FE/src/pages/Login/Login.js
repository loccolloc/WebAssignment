                ...
                <div className="mt-12">
                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            <input type="password" name="matKhau" onChange={handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập vào mật khẩu" />
                        </div>
                        <div className="mt-10">
