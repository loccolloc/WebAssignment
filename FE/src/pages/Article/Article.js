...
export default function Article() {
    return (
        <div className="main">
            ...
            <div className="main_content1  xl:mx-10 ">
                {/* ..... */}
                <div className="mx-auto all-container  container flex relative">
                    ...
                    <div className="content mx-10 w-4/5">
                            ...
                            <div>
                                ...
                                <p className="text-lg  px-2 py-2">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 text-hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                                <p className="text-lg  px-2 py-2 hidden ">Ngoại hình sang chảnh, thiết kế chiếc tai nghe tròn trịa và nhỏ gọn hơn so với phiên bản tiền nhiệm. Housing được thiết kế theo dạng hiệu ứng giọt nước trông rất bắt mắt, ngoài ra khi đeo sẽ mang lại cảm giác dễ chịu, không hề bị cấn và bí tai.</p>
                    ...
                    <div className="sidebar-qc w-2/5 ">
                       ...
                       <p className="font-bold my-4 text-xl">Xem nhiều hơn tại đây!!!!....</p>
                        ...
                        <div className="sidebar-img flex mb-6 py-4">
                            ...
                            <span className="text-base sm:text-sm sm:leading-none hover:cursor-pointer">Dưới 26 triệu lựa dòng iPhone 14 nào? Xem qua giá 5 chiếc iPhone 14 series bên dưới</span>
                        </div>
                ...
                <div className="end_content container mt-20">
                    ...
                    <div className="item-qc flex flex-row mx-40  divide-y divide-slate-200">
                        ...
                        <div className="w-3/5 py-2 md:pl-10 flex flex-col">
                            <span className=" text-slate-400 text-3xl hover:cursor-pointer hover:text-blue-600 md:leading-none"><a>Meizu 21 ra mắt: Snapdragon 8 Gen 3, camera 200MP mà giá chỉ từ 11 triệu! </a></span>
                    ...
                    <div className="item-qc flex flex-row mx-40  divide-y divide-slate-200">
                        ...
                        <div className="w-3/5 py-2 md:pl-10 flex flex-col">
                            <span className="  text-3xl hover:cursor-pointer hover:text-blue-600 md:leading-none"><a>Meizu 21 ra mắt: Snapdragon 8 Gen 3, camera 200MP mà giá chỉ từ 11 triệu! </a></span>
                            <span className="text-sm py-2 ">10 bài viết</span>
                            <span className=" text-sm"> Lê Phan Quốc Vũ <span className="text-sm text-slate-400 mx-2">15 phút trước</span></span>
                        </div>
                    </div>  

                    <div className="item-qc flex flex-row mx-40 md:my-10  divide-y divide-slate-200">
                        <span className="w-2/5 h-64"> <img className="rounded-lg  w-96 " src="https://cdn.tgdd.vn/News/Thumb/1556265/image--54--2-1200x675.jpg"></img></span>
                        <div className="w-3/5 py-2 md:pl-10 flex flex-col">
                            <span className=" text-3xl hover:cursor-pointer hover:text-blue-600 md:leading-none"><a>Meizu 21 ra mắt: Snapdragon 8 Gen 3, camera 200MP mà giá chỉ từ 11 triệu! </a></span>
                            <span className="text-sm py-2 ">10 bài viết</span>
                            <span className=" text-sm"> Lê Phan Quốc Vũ <span className="text-sm text-slate-400 mx-2">15 phút trước</span></span>
