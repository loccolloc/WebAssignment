...
export default function Register(props) {
    ...
    const submitForm = (e) => {
        ...
        // axios.post("http://localhost/index.php", sendData).then((result) => {
                ...
                <div className="mt-12">
                    <div>
                        <div>
                            ...
                            <input onChange={handleChange} value={data.taiKhoan} type='text' name="taiKhoan" className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 " placeholder="Nhập vào tài khoản" />
                        </div>
                        <div className="mt-8">
                          ...
                          cursor-pointer">
                            ...
                            <input onChange={handleChange} value={data.matKhau} type="password" name="matKhau" className=" w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập vào mật khẩu" />
                        </div>
                        <div className="mt-10">
                            <input type='submit' className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                  font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                  shadow-lg" value="Đăng ký" />
