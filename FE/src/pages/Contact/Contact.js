                ...
                <section >
                    ...
                    <div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center p-4">
                            ...
                            <h3 className="my-3 text-2xl font-semibold dark:dark:text-gray-400 text-center ">Kết Nối Với Chúng Tôi</h3>
                            <div className="space-y-1 leadi">
                        ...
                        <div className="flex flex-col items-center p-4">
                            ...
                            <h3 className="my-3 text-2xl font-semibold dark:dark:text-gray-400 text-center">Giờ Làm Việc</h3>
                            <div className="space-y-1 leadi">
                    ...
                    <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                        ...
                        <form noValidate className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                            ...
                            <label className="block">
                                ...
                                <Textarea rows={3} className="block w-full rounded-md focus:ring focus:ri focus:ri " defaultValue={""} />
                            </label>
                            <Button type="button" className=" px-8 py-3 font-semibold rounded text-white mr-2" fullWidth>Gửi</Button>
                        </form>
                    </div>
                </section>
            </div>
